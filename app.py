...
def tree_to_code(tree, feature_names, y):
    ...
    def recurse(node, depth):
        ...
        if tree_.feature[node] != _tree.TREE_UNDEFINED:
            ...
            counter1 += 1
            print(counter1)
            function += "{}return {}\n".format(indent, get_output(tree_.value[node]))
            if counter1 == 1:
...
"""Variabelen"""
klasses = ['1011000', '1020700', '1021100', '1030500', '1030901', '2030900', '2050300', '2060701',
                   '2061100', '2120300', '2120803', '2140300', '2170701', '2170705', '3010201', '3020200',
                   '3030100', '3031101', '3060205', '3070403', '6020100', '6020300', '6030300', '7010500',
                   '8020205', '8040000', '9020100', '10010300', '11000100', '13010100', '14010802', '17010000',
                   '18010100', '18020100', '18030500', '18040100', '18060301', '18060302', '18080000', '18100200',
                   '18110000', '18120000', '20010200', '23010000', '23020000']
#counter_answer = 0
#_QUESTIONS = []
...
def index():
    ...
    filename_model = '/Users/jacob/Documents/2NMCT1/Sem 2/Project lll/Flask/TVH_Flask/static/model/my_model_test.h5'
    global model, dataset_one_hot_encoding
    model = load_model(filename_model)
    dataset_one_hot_encoding = pd.read_excel(
        open('/Users/jacob/Documents/2NMCT1/Sem 2/Project lll/Flask/TVH_Flask/static/data/one_hot_encoding.xlsx', 'rb'),
        sheet_name='Sheet1')
...
app.config['UPLOADED_PHOTOS_DEST'] = '/Users/jacob/Documents/2NMCT1/Sem 2/Project lll/Flask/TVH_Flask/static/uploads'
configure_uploads(app, photos)

@app.route('/upload', methods=['GET', 'POST'])
def upload():
    """Globale variabelen"""
    global model, dataset_one_hot_encoding, klasses, d, counter_answer
    ...
    if request.method == 'POST' and 'photo' in request.files:
        ...
        _IMAGE ='/Users/jacob/Documents/2NMCT1/Sem 2/Project lll/Flask/TVH_Flask/static/uploads/%s' % filename
...
def prediction(group, maximum):
    ...
    d_chars = pd.read_excel(
        open('/Users/jacob/Documents/2NMCT1/Sem 2/Project lll/Flask/TVH_Flask/static/data/output.xlsx', 'rb'),
        sheet_name='Sheet1')
    chars_list = list(d_chars.loc[d_chars.GroupCode.isin([int(group)]), 'CHARS'])
    chars_list = chars_list[0].split(',')
    chars_list = [x.strip() for x in chars_list]
    print('chars', chars_list)
    return render_template('prediction.html', group = group, maximum = int(maximum*100), chars_list = chars_list[:5])
